...
class PicMessage(BasicMessage):
    ...
    def __unicode__(self):
        return self.message_type + ':' + self.media_id
...
class TemplateEvent(BasicEvent):
    msgid = models.CharField(default="", max_length=500)
    status = models.CharField(default="", max_length=500)

    def __unicode__(self):
        return self.msgid  # todo
...
class LocationEvent(BasicEvent):
    ...
    def __unicode__(self):
        return self.latitude + ':' + self.longitude + ':' + self.precision
...
class MenuEvent(BasicEvent):
    ...
    def __unicode__(self):
        return self.event_key  # todo


class MessageAutoReplay(models.Model):
    content = models.CharField(max_length=500, default="")
    rule = models.CharField(max_length=500, default="")
    create_time = models.DateTimeField(default=datetime.datetime.now)
